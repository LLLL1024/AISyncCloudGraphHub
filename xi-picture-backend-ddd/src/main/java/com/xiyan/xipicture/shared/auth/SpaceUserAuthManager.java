...
import com.xiyan.xipicture.shared.auth.model.SpaceUserAuthConfig;
import com.xiyan.xipicture.shared.auth.model.SpaceUserPermissionConstant;
import com.xiyan.xipicture.shared.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    // static{} 是一个静态代码块，它在类被加载到 JVM（Java虚拟机）时执行，且只执行一次。静态代码块通常用于初始化静态变量。
    static {
