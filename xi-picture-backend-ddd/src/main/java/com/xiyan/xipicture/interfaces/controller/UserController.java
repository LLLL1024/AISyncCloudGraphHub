...
import com.xiyan.xipicture.interfaces.assembler.UserAssembler;
import com.xiyan.xipicture.interfaces.dto.user.*;
...
public class UserController {
    ...
    /**
     * 分页获取用户封装列表（仅管理员）
     * 为什么查询用post而不用get：原因是post传递的参数范围比get的大，接收数据量的限制比get的大，所以涉及到复杂的查询或复杂参数的传递建议用post
     *
